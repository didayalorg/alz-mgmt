...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "admin@contoso.com"
    ...
    dcr_change_tracking_name                = "dcr-change-tracking" #[Design decision] not needed.
    dcr_defender_sql_name                   = "dcr-defender-sql"    #[Design decision] not needed.
    dcr_vm_insights_name                    = "dcr-vm-insights"     #[Design decision] not needed.

    # Baseline monitoring names
...
management_resource_settings = {
  ...
  #[Design decision] Not needed but variable input is required.
...
management_group_settings = {
  ...
  policy_default_values = {
    ...
    amba_alz_arm_role_id                           = ["Owner", "Contributor"]
  ...
  subscription_placement = {
    ...
    management = {
      ...
      management_group_name = "HAL-ALZ-Platform"
    }
    # security = {
  ...
  # Key must be the ID of the target management group.

  # In the alzlib , Deploy-MDFC-Config_20240319 is the policy set, and Deploy-MDFC-Config-H224 is the assignment (part of root archetype)
